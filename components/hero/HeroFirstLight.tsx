 ...
 *
 * SIJO's own tagline, placed asymmetrically over the shared DawnEnvironment.
 * The cold-open bloom and the dawn live in the environment; the type stays
    ...
    <Beat id="hero">
      <div className="mr-auto max-w-2xl text-left">
        ...
        <p className="mt-7 max-w-md text-lg leading-relaxed text-white/70 [text-shadow:0_1px_20px_rgba(0,0,0,0.55)]">
          L&apos;intelligence et la force du collectif façonnent l&apos;avenir.
        </p>

        <div className="mt-10">
          <Button href="#cta">Nous contacter</Button>
        </div>
      </div>
    </Beat>
  );
